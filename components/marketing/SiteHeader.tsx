    ...
    >
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6">
        ...
        <nav className="flex items-center gap-2 sm:gap-3">
          ...
          <Link
            href="/signup"
            className="rounded-lg bg-yellow-400 px-3 py-2 text-sm font-semibold text-navy-950 transition-all duration-250 ease-enter hover:bg-yellow-300 hover:scale-105 active:scale-95 sm:px-4"
          >
            Sign up
          </Link>
        </nav>
